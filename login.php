...
if (isset($_POST['login_btn'])) {
  ...
  if (isset($result[0])) {
    ...
    echo "<script>alert('ایمل یا رمز عبور اشتباه است')</script>";
  }
  ...
  <div class="login-box">
    ...
    <div class="card">
      <div class="card-body login-card-body">
        <h1 class="login-box-msg">ورود به پنل</h1>
          ...
          <div class="row">
            ...
            <div class="col-4">
              <div class="d-grid gap-2">
                <button type="submit" name="login_btn" class="btn btn-primary">ورود</button>
              </div>
            </div>
            <!-- /.col -->
          </div>
